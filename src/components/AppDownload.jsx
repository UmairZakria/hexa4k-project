          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              <button
                ...
                className="bg--DEFAULT cursor-pointer  dark:text-white  rounded-lg flex items-center gap-4 lg:gap-[1vw]"
              >
                <img
                ...
                <div className="text-left">
                  <div className="text-[14px] md:text-sm font-semibold">DIRECT DOWNLOAD</div>
                  <div className="text-[16px] md:text-lg font-bold">.APK FILE</div>
                </div>
              </button>
            </a>
            <a
            ...
            >
              <button
                // onClick={() => handleDownload(apkOption.downloadUrl)}
                className=" cursor-pointer dark:text-white rounded-lg flex items-center gap-4 lg:gap-[1vw]"
              >
                <img
                  className="size-10 lg:h-[2vw] lg:w-[2vw]"
                  src={icons.ios}
